    ...
    <section id="home" className="flex flex-col md:flex-row justify-between items-center px-4 sm:px-6 lg:px-8 pt-44 pb-16 container mx-auto">
      ...
      <div className="w-full md:w-1/2 space-y-6">
        <motion.div variants={fadeIn('right', 0.2)} initial="hidden" whileInView="show">
          {/* Star badge */}
          <div className="flex items-center gap-2 bg-background-color w-fit px-4 py-2 rounded-full hover:bg-card-background transition-colors cursor-pointer group">
        ...
        <motion.p 
          ...
          initial="hidden"
          whileInView="show"
          className="text-text-color text-lg md:text-xl max-w-xl -mt-2 transition-colors duration-300"
        >
        ...
        >
          <input
              ...
              className="flex-1 px-6 py-4 border border-border-color rounded-xl focus:outline-none focus:border-blue-600 focus:ring-2 focus:ring-blue-100  transition-all text-text-color bg-card-background transition-colors duration-300"
            />
          <button
            onClick={() => {
