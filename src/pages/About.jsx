          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <motion.div
                ...
                className={`p-6 rounded-xl text-center border border-purple-900 shadow-[0_0_10px_rgba(139,92,246,0.3)] transition-all duration-300 transition- ease-in-out hover:shadow-[0_0_15px_rgba(139,92,246,0.6)] hover:border-purple-600
                ${
                  isDarkMode
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {coreValues.map((value, index) => (
              <motion.div
                key={index}
                variants={fadeIn("up", 0.2 * index)}
                className={`p-6 rounded-xl text-center border border-purple-900 shadow-[0_0_10px_rgba(139,92,246,0.2)] transition-all duration-300 transition- ease-in-out hover:shadow-[0_0_15px_rgba(139,92,246,0.6)] hover:border-purple-600
                ${
                  isDarkMode
                    ? "bg-white/10 backdrop-blur-md"
                    : "bg-white/70 shadow-lg"
