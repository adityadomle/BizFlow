...
const ContributorGuide = () => {
  ...
  const steps = [
    {
      ...
      details:
        "This creates a personal copy of the project in your GitHub account that you can freely modify.",
    },
    {
      icon: <FiTerminal className="w-6 h-6" />,
      title: "Clone Locally",
      description:
        "Download your forked repository to your computer using git clone.",
      details:
        "This creates a local working copy where you can make and test your changes.",
    },
    {
      icon: <FiGitBranch className="w-6 h-6" />,
      ...
      details:
        "Branches keep your changes organized and separate from the main codebase.",
    },
    {
      icon: <FiGitCommit className="w-6 h-6" />,
      title: "Make Changes",
      description:
        "Edit files, add features, or fix bugs in your local repository.",
      details:
        "Take your time to write clean, well-documented code that follows the project standards.",
    },
    {
      icon: <FiGitCommit className="w-6 h-6" />,
      title: "Commit & Push",
      ...
      details:
        "Write clear commit messages that explain what changes you made and why.",
    },
    {
      ...
      details:
        "Describe your changes clearly and be open to feedback from maintainers.",
    },
  ];
  ...
  const prSteps = [
    ...
    },
    {
      ...
      description:
        'Click the green "New pull request" button to start creating your PR.',
    ...
    },
    {
      ...
      description:
        "GitHub will show you a diff of all the changes you've made. Review them carefully.",
    ...
    },
    {
      ...
      description:
        "Create a clear, concise title that summarizes what your PR accomplishes.",
    ...
    },
    {
      ...
      description:
        "Explain what changes you made, why you made them, and how to test them.",
  ...
  const faqs = [
    {
      ...
      answer:
        "A fork is your personal copy of someone else's repository. It allows you to freely experiment with changes without affecting the original project. You can later submit your changes back to the original project through a pull request.",
      category: "basics",
    ...
    },
    {
      ...
      answer:
        "A pull request (PR) is a way to propose changes to a repository. It lets you tell others about changes you've pushed to a GitHub repository and request that your changes be reviewed and potentially merged into the main project.",
      category: "basics",
    ...
    },
    {
      ...
      answer:
        'Use descriptive names like "feature/user-authentication", "fix/login-bug", or "docs/readme-update". Avoid generic names like "my-changes" or "patch". The name should clearly indicate what the branch contains.',
      category: "workflow",
      icon: <FiGitBranch className="w-5 h-5" />,
    },
    {
      ...
      answer:
        'Start with a verb like "Add", "Fix", "Update", or "Remove". Keep it under 50 characters for the title. Example: "Add user profile validation" or "Fix header responsive design issue".',
      category: "workflow",
    ...
    },
    {
      ...
      answer:
        "Don't take it personally! Rejections often happen due to timing, project direction, or minor issues that can be fixed. Read the feedback carefully, ask questions if unclear, and use it as a learning opportunity.",
    ...
    },
    {
      ...
      answer:
        "Merge conflicts occur when your changes conflict with recent updates to the main branch. Pull the latest changes, resolve conflicts manually in your editor, then commit the resolution. Many IDEs have built-in tools to help with this.",
      category: "troubleshooting",
      icon: <FiAlertCircle className="w-5 h-5" />,
    },
    {
      ...
      answer:
        "Don't worry! Git is designed to handle mistakes. You can always create new commits to fix issues, or ask for help in the project's discussion forums. The maintainers are usually happy to help newcomers.",
      category: "troubleshooting",
    ...
    },
    {
      ...
      answer:
        "Review times vary by project and maintainer availability. Some PRs are reviewed within hours, others may take days or weeks. Be patient and don't hesitate to politely follow up if there's no response after a reasonable time.",
      category: "process",
    ...
    },
    {
      ...
      answer:
        "For significant changes or new features, yes! Create an issue first to discuss your idea with maintainers. For small bug fixes or typos, you can usually go straight to a PR.",
      category: "process",
    ...
    },
    {
      ...
      answer:
        "Simply make the requested changes in your local branch, commit them, and push to the same branch. Your PR will automatically update with the new commits.",
      category: "process",
    ...
    >
      ...
      >
        <motion.div variants={textVariant(0.3)} className="max-w-4xl mx-auto">
          ...
          >
            We're thrilled you want to contribute! Let's make your first
            contribution smooth and enjoyable.
          </p>
          <div
            className={`${
          ...
          >
            ...
            >
              Every expert was once a beginner. This guide will walk you through
              everything you need to know to make your first contribution with
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {steps.map((step, index) => (
            <motion.div
              ...
              className={`${
                isDarkMode ? "bg-slate-800" : "bg-white"
              } rounded-xl shadow-lg p-6 border-l-4 border-blue-600 hover:shadow-xl transition-all duration-300 transform hover:scale-105`}
            >
              ...
              {/* learn more btn */}
              <button
                onClick={() => navigate(`/learn/${index + 1}`)}
                className={`
                            relative overflow-hidden mt-4 group min-w-[100px] xl:min-w-[130px] px-3 xl:px-5 py-2 xl:py-2.5 
      ...
      >
        ...
        <div
          ...
          } rounded-xl p-4 md:p-6 shadow-2xl`}
        >
          <div className="space-y-4">
            {commands.map((cmd) => (
              <div
                key={cmd.id}
                className={`${
                  isDarkMode ? "bg-slate-950" : "bg-gray-950"
                } rounded-lg p-3 md:p-4`}
              >
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-2">
                  <h4 className="text-blue-300 font-semibold text-sm md:text-base">
                    {cmd.title}
                  </h4>
                  <button
                ...
                <code className="text-blue-300 block mb-2 font-mono text-sm md:text-base break-all">
                  {cmd.command}
                </code>
      ...
      >
        <div className="text-center mb-12">
          ...
          >
            Once you've pushed your changes, it's time to create a pull request.
            This is where your contribution gets reviewed and potentially merged
        ...
        >
          <div className="space-y-6 md:space-y-8">
            {prSteps.map((step, index) => (
              <div
                key={index}
                className="flex flex-col md:flex-row md:items-start space-y-4 md:space-y-0 md:space-x-6 group"
              >
                <div className="flex-shrink-0 self-center md:self-start">
                  ...
                  <div
                    className={`hidden md:block w-px h-12 bg-blue-300 mx-auto mt-4 ${
                      index === prSteps.length - 1 ? "hidden" : ""
                    }`}
                  ></div>
                </div>
                <div
                  ...
                  } rounded-xl p-4 md:p-6 shadow-lg hover:shadow-xl transition-all duration-300`}
                >
                  ...
                  <div
                    ...
                    } rounded-lg p-3 border-l-4 border-blue-500`}
                  >
                    <p
      ...
      >
        ...
        {Object.entries(faqCategories).map(([categoryKey, categoryInfo]) => {
          const categoryFaqs = faqs.filter(
            (faq) => faq.category === categoryKey
          );

          return (
            <div key={categoryKey} className="mb-8">
              <h3
                className={`text-xl font-bold mb-4 border-l-4 border-blue-600 pl-4 ${
                  categoryInfo.color
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {resources.map((resource, index) => (
            <a
              ...
              className={`${
                isDarkMode ? "bg-slate-800" : "bg-white"
              } rounded-xl shadow-lg p-6 hover:shadow-xl transition-all duration-500 transform hover:-translate-y-1 hover:scale-105 group`}
            >
              <div className="flex items-center mb-4">
      ...
      >
        ...
        >
          ...
          >
            You're all set! Remember, the community is here to support you every
            step of the way.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={() =>
                window.open("https://github.com/adityadomle/BizFlow", "_blank")
              }
            ...
            <button
              ...
              } px-8 py-3 rounded-lg font-semibold transition-all duration-300 hover:scale-105 transform hover:-translate-y-0.5`}
            >
          ...
          >
            💡 Pro tip: Don't hesitate to ask questions in our community
            channels. We're all here to help!
          </p>
        </div>
      </motion.section>
    </div>
